      ...
      >
        <Flex w="90%" justifyContent="space-between" alignItems="center">
          ...
          <Flex w="49%" justifyContent="space-between">
            <Flex gap="34px" flexDirection="column" alignItems="start" justifyContent="center">
              <Text size="s" color="gray.300" mt="2px" letterSpacing="-0.28px" fontFamily="Onest">
                Properties
              </Text>
              <UnorderedList
                styleType="none"
            ...
            <Flex gap="32px" flexDirection="column" alignItems="start" py="4px">
            ...
            <Flex gap="35px" flexDirection="column" alignItems="start" py="3px">
              <Text size="s" color="gray.300" letterSpacing="-0.28px" fontFamily="Onest">
                Account
              </Text>
              <UnorderedList
        ...
        <Flex mt="31px" w="100%" justifyContent="space-between" alignItems="center">
          ...
          <Flex justifyContent="space-between" gap="16px">
            <IconButton
              ...
              aria-label="534:1727-closelinetwo"
              w="48px"
              borderRadius="50%"
            />
            <IconButton
              ...
              aria-label="534:1728-closelinetwo"
              w="48px"
              borderRadius="50%"
            />
            <IconButton
              ...
              aria-label="534:1729-closelinetwo"
              w="48px"
              borderRadius="50%"
            />
          </Flex>
